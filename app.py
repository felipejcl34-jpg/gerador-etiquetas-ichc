...
with c3: med_un = st.selectbox("Unidade", ["ML", "MG", "MCG", "UI", "GTS", "COMP", "FRASCO", "BISNAGA", "DOSE", "CP"], key=f"med_un_{v_cont}")
with c4: med_via = st.selectbox("Via", ["IV", "IM", "SC", "GTRS", "SNE", "VO", "NASAL", "RETAL", "DERM", "INAL", "IN O", "SL", "VAG", "OTO", "OTOE", "OTOD", "OFT", "OFTE", "OFTD", "BC", "ENV"], key=f"med_via_{v_cont}")
